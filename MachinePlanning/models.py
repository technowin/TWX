...
class BatchRoutingLog(models.Model):
    ...
    quantity_pass = models.IntegerField(null=True, blank=True)
    quantity_reject = models.IntegerField(null=True, blank=True)
...
# class COGCalculation(models.Model):
#     bom = models.ForeignKey(BOMHeader)
#     workstation = models.ForeignKey(Works)
