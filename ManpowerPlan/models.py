...
class Employee(models.Model):
    ...
    work_center = models.ForeignKey("MachinePlanning.WorkCenters", on_delete=models.CASCADE, verbose_name="Primary Work Center")
    ...
    created_by = models.ForeignKey('Account.CustomUser',on_delete=models.SET_NULL,null=True,blank=True,related_name='employee_created_by',verbose_name="Created By")
    updated_by = models.ForeignKey('Account.CustomUser',on_delete=models.SET_NULL,null=True,blank=True,related_name='employee_updated_by',verbose_name="Updated By")
...
class Skill(models.Model):
    ...
    created_by = models.ForeignKey('Account.CustomUser',on_delete=models.SET_NULL,null=True,blank=True,related_name='skill_created_by',verbose_name="Created By")
    updated_by = models.ForeignKey('Account.CustomUser',on_delete=models.SET_NULL,null=True,blank=True,related_name='skill_updated_by',verbose_name="Updated By")
    created_at = models.DateTimeField(auto_now_add=True,null=True, blank=True)
    updated_at = models.DateTimeField(auto_now=True,null=True, blank=True)
...
class EmployeeSkill(models.Model):
    ...
    created_by = models.ForeignKey('Account.CustomUser',on_delete=models.SET_NULL,null=True,blank=True,related_name='employee_skill_created_by',verbose_name="Created By")
    updated_by = models.ForeignKey('Account.CustomUser',on_delete=models.SET_NULL,null=True,blank=True,related_name='employee_skill_updated_by',verbose_name="Updated By")
    created_at = models.DateTimeField(auto_now_add=True,null=True, blank=True)
    updated_at = models.DateTimeField(auto_now=True,null=True, blank=True)
...
class Shift(models.Model):
    ...
    is_active = models.BooleanField(default=True)
    created_by = models.ForeignKey('Account.CustomUser',on_delete=models.SET_NULL,null=True,blank=True,related_name='shift_created_by',verbose_name="Created By")
    updated_by = models.ForeignKey('Account.CustomUser',on_delete=models.SET_NULL,null=True,blank=True,related_name='shift_updated_by',verbose_name="Updated By")
    created_at = models.DateTimeField(auto_now_add=True,null=True, blank=True)
    updated_at = models.DateTimeField(auto_now=True,null=True, blank=True)
...
class LaborRequirement(models.Model):
    ...
    created_by = models.ForeignKey('Account.CustomUser',on_delete=models.SET_NULL,null=True,blank=True,related_name='labor_created_by',verbose_name="Created By")
    updated_by = models.ForeignKey('Account.CustomUser',on_delete=models.SET_NULL,null=True,blank=True,related_name='labor_updated_by',verbose_name="Updated By")
    created_at = models.DateTimeField(auto_now_add=True,null=True, blank=True)
    updated_at = models.DateTimeField(auto_now=True,null=True, blank=True)
...
class LaborAssignment(models.Model):
    schedule = models.ForeignKey("MachinePlanning.MachineScheduling", on_delete=models.CASCADE, related_name='labor_assignments')
    ...
    hours_allocated = models.DecimalField(max_digits=4,decimal_places=2,validators=[MinValueValidator(0.25), MaxValueValidator(24)],verbose_name="Hours Allocated")
    status = models.CharField(max_length=20,choices=[
        ...
        ],default='planned',verbose_name="Assignment Status"
    )
    notes = models.TextField(blank=True, verbose_name="Assignment Notes")
    created_by = models.ForeignKey('Account.CustomUser',on_delete=models.SET_NULL,null=True,blank=True,related_name='labour_assi_created_by',verbose_name="Created By")
    updated_by = models.ForeignKey('Account.CustomUser',on_delete=models.SET_NULL,null=True,blank=True,related_name='labor_assi_updated_by',verbose_name="Updated By")
    created_at = models.DateTimeField(auto_now_add=True,null=True, blank=True)
    updated_at = models.DateTimeField(auto_now=True,null=True, blank=True)
...
class EmployeeAvailability(models.Model):
    ...
    notes = models.TextField(blank=True, verbose_name="Additional Notes")
    created_by = models.ForeignKey('Account.CustomUser',on_delete=models.SET_NULL,null=True,blank=True,related_name='employee_avail_created_by',verbose_name="Created By")
    updated_by = models.ForeignKey('Account.CustomUser',on_delete=models.SET_NULL,null=True,blank=True,related_name='employee_avail_updated_by',verbose_name="Updated By")
    created_at = models.DateTimeField(auto_now_add=True,null=True, blank=True)
    updated_at = models.DateTimeField(auto_now=True,null=True, blank=True)
...
class Attendance(models.Model):
    ...
    created_by = models.ForeignKey('Account.CustomUser',on_delete=models.SET_NULL,null=True,blank=True,related_name='atten_created_by',verbose_name="Created By")
    updated_by = models.ForeignKey('Account.CustomUser',on_delete=models.SET_NULL,null=True,blank=True,related_name='atten_updated_by',verbose_name="Updated By")
    created_at = models.DateTimeField(auto_now_add=True,null=True, blank=True)
    updated_at = models.DateTimeField(auto_now=True,null=True, blank=True)
...
class LeaveRequest(models.Model):
    ...
    created_by = models.ForeignKey('Account.CustomUser',on_delete=models.SET_NULL,null=True,blank=True,related_name='leave_created_by',verbose_name="Created By")
    updated_by = models.ForeignKey('Account.CustomUser',on_delete=models.SET_NULL,null=True,blank=True,related_name='leave_updated_by',verbose_name="Updated By")
    created_at = models.DateTimeField(auto_now_add=True,null=True, blank=True)
    updated_at = models.DateTimeField(auto_now=True,null=True, blank=True)
